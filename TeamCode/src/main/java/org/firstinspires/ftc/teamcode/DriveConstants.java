...
public class DriveConstants {
    ...
    public static double KICKRIGHT_FLAT = 0.30; //DO
    public static double KICKLEFT_FLAT = 0.68; //DO

    public static double OUTTAKE_DROP = 0.56;
    public static double OUTTAKE_INTAKE = 0.80;
    public static double OUTTAKE_FLAT = 0.7; //TUNE
